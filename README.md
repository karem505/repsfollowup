...
### Prerequisites
- Node.js 18+ and npm
- PostgreSQL (local installation or use Docker)
...
### Option 1: Docker (Recommended - Deploy Anywhere)

Deploy the entire stack (frontend, backend, and PostgreSQL) with Docker:
